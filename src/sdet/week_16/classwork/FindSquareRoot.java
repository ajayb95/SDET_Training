...
public class FindSquareRoot {
	...
	//Pseudo Code
	/*
	 * Iterate through each number from 1 to input/2
	 * square each element and check if the squared number matches with the input
	...
	//Pseudo code
	/*
	 * initialize left is 1,right and mid pointer where right is input/2
	 * and mid is left+right/2
	 * if square of mid element is input, return the input
	 * or check if square of mid is less than input, change left to mid+1
	 * in neither case change right to mid-1
	 * continue the looping till left becomes greater than right
	 */
